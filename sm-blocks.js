...
"use strict";
var SM, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
SM = function(){
  var BRAND, consoleError, consoleInfo, newPromise, newDelay, goFetch, soFetch, w3ui, S, M;
  BRAND = 'sm-blocks';
  ...
  importAll$(w3ui = {
    ...
    queryChildren: function(parentNode, selector){
      var a, i$, ref$, len$, b;
      a = [];
    ...
    queryChild: function(parentNode, selector){
      var a;
      if (!parentNode) {
        return null;
      }
    ...
    button: function(){
      ...
      Block = function(root, o){
        ...
        a = 'addEventListener';
        e = w3ui.event;
        root[a]('pointerenter', e.hover(this));
        root[a]('pointerleave', e.unhover(this));
        root[a]('focus', e.focus(this));
        root[a]('blur', e.unfocus(this));
  ...
  S = {
    productCard: function(){
      var init, sizes, template, section, Items, Block;
      init = newPromise();
      sizes = null;
      template = w3ui.template(function(){
        /*
        ...
        actions: function(){
          ...
          Item.prototype = {
            ...
            openDetails: function(){
              var this$ = this;
              return async function(){
                window.location.assign(this$.block.data.link);
      ...
      Items = function(block){
        ...
        for (a in section) {
          this[a] = new section[a](block, cfg);
        }
      };
  ...
  M = {
    ...
    'menu': function(){
      var tItem, tArrow, tLineA, tLineB, fOrder, fAssembly, Resizer, Item, Block;
      ...
      Resizer.prototype = {
        init: function(){
          this.obs = new ResizeObserver(this.update);
      ...
      Item = function(block, id, data, parent){
        ...
        this.hovered = false;
        this.locked = false;
        this.onHover = function(flag, drop){
          this$.block.onHover(flag, this$.button);
        };
      };
      Item.prototype = {
        init: function(level){
          ...
          if (this.children) {
            ...
            a.addEventListener('pointerenter', w3ui.event.hover(this));
            a.addEventListener('pointerleave', w3ui.event.unhover(this));
      ...
      Block = function(root){
        ...
        this.resize = w3ui.event.resizeAccum(function(e){
          ...
          while (++a < b) {
            for (i$ = 0, len$ = (ref$ = this$.levels[a]).length; i$ < len$; ++i$) {
              c = ref$[i$];
              if (c.dropdown) {
