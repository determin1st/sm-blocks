...
sm = function(){
  var BRAND, consoleError, consoleInfo, newPromise, newDelay, querySelectorChildren, querySelectorChild, queryFirstChildren, goFetch, soFetch, w3ui, S, M, Config, State, Loader, Group, newResizer, SUPERVISOR;
  BRAND = 'sm-blocks';
  ...
  importAll$(w3ui = {
    ...
    event: {
      hover: function(B){
        return function(e){
          e.preventDefault();
          if (!B.locked && !B.pending && !B.hovered) {
            B.hovered = true;
      ...
      section = {
        ...
        actions: function(){
          ...
          Item = function(block, cfg){
            ...
            this.buttons = btn = w3ui.dom.append(box, [
              w3ui.button({
                name: 'add',
                html: TCartIcon,
